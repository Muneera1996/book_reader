...
class _BookDetailsScreenState extends State<BookDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    String descriptionText = book.description.isNotEmpty
        ? book.description
        : Constants.noDescription;

    return Scaffold(
      floatingActionButton:
          Builder(builder: (context) => _floatingButton(context, book)),
      appBar: AppBar(
...
FloatingActionButton _floatingButton(BuildContext context, Book book) {
  return FloatingActionButton(
    onPressed: () {
      bool itemAdded =
          Provider.of<AppNotifier>(context, listen: false).addCartItem(book);
      if (itemAdded) {
